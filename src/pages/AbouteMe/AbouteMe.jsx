        ...
        <div className="pt-6 lg:pt-0 lg:w-2/5 text-start">
          ...
          <div className="pt-2">
            ...
            <div className="flex gap-2">
              ...
              <h3 className="text-gray-400">{t('personalInfo.residenceValue')}</h3>
            </div>
            <div className="flex gap-2">
              <h1>{t('personalInfo.address')}:</h1>
              <h3 className="text-gray-400">{t('personalInfo.addressValue')}</h3>
            </div>
            <div className="flex gap-2">
            ...
            <div className="flex gap-2">
              ...
              <h3 className="text-gray-400">{t('personalInfo.freelanceValue')}</h3>
            </div>
          </div>
        </div>
      </div>
