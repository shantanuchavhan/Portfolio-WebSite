          ...
          <div>
            <div className="pt-2">
              <p className="text-gray-500 text-[18px]">
                <span className="text-gray-300">Greetings!</span> I'm a skilled
                ...
                <span className="text-gray-300"> Let's collaborate </span> to
                turn your digital vision into a dynamic reality!
              </p>
            </div>
          </div>
        </div>
