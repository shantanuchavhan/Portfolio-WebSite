      ...
      <section className="">
        <div className="py-8 lg:py-12 lg:px-20 px-6 mx-auto max-w-screen-md">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className={`py-3 bg-${color} px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800`}
            >
              {t("Send message")}
            </button>
          </form>
