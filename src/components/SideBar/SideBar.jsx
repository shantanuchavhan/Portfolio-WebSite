...
const SideBar = ({ setIsOpen }) => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col min-h-screen fixed top-0  bottom-0    relative  items-center justify-center shadow-right text-gray-500 border-r-1 border-color-wheat"
    >
